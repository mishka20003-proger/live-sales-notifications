...
CREATE TABLE "new_AppSettings" (
    ...
    "fakePriceMode" TEXT NOT NULL DEFAULT 'random',
...
INSERT INTO "new_AppSettings" ("createdAt", "customCSS", "dataSource", "displayDuration", "displayInterval", "enabled", "fakeInterval", "fakePriceMax", "fakePriceMin", "hideOnMobile", "hideOnSpecificPages", "id", "initialDelay", "maxNotifications", "ordersTimeframe", "position", "shop", "showCustomerName", "showOrderNumber", "showProductImage", "showTotalPrice", "size", "totalShows", "updatedAt") SELECT "createdAt", "customCSS", "dataSource", "displayDuration", "displayInterval", "enabled", "fakeInterval", "fakePriceMax", "fakePriceMin", "hideOnMobile", "hideOnSpecificPages", "id", "initialDelay", "maxNotifications", "ordersTimeframe", "position", "shop", "showCustomerName", "showOrderNumber", "showProductImage", "showTotalPrice", "size", "totalShows", "updatedAt" FROM "AppSettings";
